...
public class ShowScrapMessageTask extends AsyncTask<Void, Void, List<Message>> {
    ...
    public static final String url = "jdbc:mysql://project.c9zirfty1roz.ap-northeast-2.rds.amazonaws.com:3306/" +
            DATABASE_NAME;
    public static final String username = "kimdozz0", password = "1987qpzx!";
